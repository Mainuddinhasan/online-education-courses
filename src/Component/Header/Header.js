...
return (
<div>
    <nav className="fixed-top d-flex bd-highlight navbar navbar-expand-lg navbar-light bg-secondary">
        <a className="text-white font-weight-bold p-2 flex-grow-1 bd-highlight navbar-brand" href="#"></a>
